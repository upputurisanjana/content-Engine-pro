...
st.info(
    ...
    "This tool uses OpenRouter (GPT-4o Mini, Seedream 4.5, Wan 2.6) and OpenAI TTS."
)
...
if clicked:
    ...
    with right:
        ...
        elif hero_image_bytes:
            st.warning("⚠️ Video generation failed. The hero image was produced but video rendering did not complete.")
        else:
            st.info("Video not generated — hero image is required.")
    ...
    st.caption("Technique: Script adaptation + OpenAI TTS (tts-1) — powered by GPT-4o Mini")
    ...
    if audio_bytes:
        ...
        st.warning("⚠️ Voiceover generation failed. Check your OpenAI/OpenRouter API key and TTS quota.")
    else:
        st.info("Voiceover not available — blog intro is required to generate audio.")
